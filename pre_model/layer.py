...
from pre_model.sparse_softmax import Sparsemax
...
# from torch_geometric.nn.pool.topk_pool import FilterEdges
from torch_geometric.nn.pool.connect import filter_edges
from torch_geometric.utils import softmax, dense_to_sparse, add_remaining_self_loops
from torch_scatter import scatter_add
from torch_sparse import spspmm, coalesce
from pre_model.config import parse
...
class MVPool(torch.nn.Module):
    def __init__(self, in_channels, ratio, negative_slop=0.2):
    ...
    def forward(self, x, edge_index, edge_attr, batch=None):
        ...
        perm = torch.topk(score, k=k).indices
